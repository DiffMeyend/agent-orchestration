/**
 * Resonant Agent Permissions
 *
 * Resonant performs research and alignment. Read-only with context writing.
 */
...
/**
 * Resonant permission matrix (read-only reference)
 */
export const RESONANT_PERMISSIONS = PERMISSION_MATRIX[AGENT_ID];
